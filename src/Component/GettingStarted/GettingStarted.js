...
const GettingStarted = () => {
  ...
  const installation = (
    <>
      <li>
        ...
        {/*   <label onClick={handleClick} className="modal-button modal-open" htmlFor="my-modal-3">
  ...
  const installation2 = (
    <>
      ...
      <li>
        <Link to="/gettingStarted/typescriptQuickStart">Typescript Quick Start</Link>
      </li>
      <li>
  ...
  return (
    <div className="drawer drawer-mobile pt-20">
     ...
     {/* {
        show === true && <LoginPopUp></LoginPopUp>       
      }  */}
    </div>
  );
};
