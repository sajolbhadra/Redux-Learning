    ...
    return (
        <div className='mt-20'>
            <div>
                ...
                <ul style={{ listStyle: "square" }} className="leading-10 text-lg px-20 list-disc">
                ...
                <p className='text-2xl font-bold mt-8'>Redux code also includes the following features</p>
                <ul style={{ listStyle: "square" }} className="leading-10 text-lg px-20 list-disc">
            ...
            <div>
                <p className='text-2xl font-bold'>Why Redux?</p>
                <p  className="leading-10 text-lg px-20 list-disc">
                    Redux is a predictable state container designed to help you write JavaScript apps that behave consistently across client, server, and native environments and are easy to test. While it's mostly used as a state management tool with React, you can use it with any other JavaScript framework or library.
                </p>
                <p className='text-2xl font-bold mt-8'>Where is Redux used?</p>
                <p  className="leading-10 text-lg px-20 list-disc">
                ...
                <p className='text-2xl font-bold'>Is Redux hard to learn?</p>
                <p  className="leading-10 text-lg px-20 list-disc">
                ...
                <p className='text-2xl font-bold mt-8'>Is Redux required for React?</p>
                <p className="leading-10 text-lg px-20 list-disc">
            ...
            <div>
                <p className='text-2xl font-bold'>Introduction to Redux ToolKit and Usage</p>
                <p className='text-xl font-bold'>What is Redux Toolkit </p>
                <p style={{ listStyle: "square" }} className="leading-10 text-lg px-20 list-disc">
                ...
                <p className='text-2xl font-bold mt-8'>Why do we need Redux Toolkit?</p>
                <p style={{ listStyle: "square" }} className="leading-10 text-lg px-20 list-disc">
                    The Redux core is a very small library. It provides only few small API primitives
                </p>
                <p style={{ listStyle: "square" }} className="leading-10 text-lg px-20 list-disc">
