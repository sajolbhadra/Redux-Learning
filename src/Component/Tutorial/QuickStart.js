        ...
        <div className='leading-relaxed'>
            <div className='grid grid-flow-row-dense grid-cols-10 bg-white'>
                <div className='col-span-10 lg:col-span-8 mx-4'>
                    ...
                    <p className='mb-5'>
                        This page will focus on just how to set up a Redux application with Redux Toolkit and the main APIs you'll use. For explanations of what Redux is, how it works, and full examples of how to use Redux Toolkit,<Link to={'/tutorial'} className='text-[#764abc] hover:underline'> see the tutorials linked in the "Tutorials Index" page.</Link>
                    </p>
                    <p className='mb-5'>
                        For this tutorial, we assume that you're using Redux Toolkit with React, but you can also use it with other UI layers as well. The examples are based on a <Link to={'/tutorial'} className='text-[#764abc] hover:underline'> typical Create-React-App folder structure</Link> where all the application code is in a <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>src</span>, but the patterns can be adapted to whatever project or folder setup you're using.
                    </p>
                    <p className='mb-5'>
                        The <Link to={'/tutorial'} className='text-[#764abc] hover:underline'>Redux+JS template for Create-React-App</Link> comes with this same project setup already configured.
                    </p>
                    ...
                    <p className='mb-5'>
                        Create a file named <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>src/app/store.js.</span> Import the <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>configureStore</span> API from Redux Toolkit. We'll start by creating an empty Redux store, and exporting it:
                    </p>
                    ...
                    <p className='mb-5'>
                        Once the store is created, we can make it available to our React components by putting a React-Redux<span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>&#60;Provider&#62;</span>  around our application in <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>src/index.js.</span> Import the Redux store we just created, put a <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>&#60;Provider&#62;</span> around your <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>&#60;App&#62;</span>, and pass the store as a prop:
                    </p>
                    ...
                    <h3 className='text-3xl font-bold mb-5'>Create a Redux State Slice</h3>
                    <p className='mb-5'>
                        Add a new file named <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>src/features/counter/counterSlice.js</span>. In that file, import the <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>createSlice</span> API from Redux Toolkit.
                    </p>
                    <p className='mb-5'>
                        Creating a slice requires a string name to identify the slice, an initial state value, and one or more reducer functions to define how the state can be updated. Once a slice is created, we can export the generated Redux action creators and the reducer function for the whole slice.
                    </p>
                    <p className='mb-5'>
                        Redux requires that <Link to={'/tutorial'} className='text-[#764abc] hover:underline'>we write all state updates immutably, by making copies</Link> of data and updating the copies. However, Redux Toolkit's <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>createSlice</span> and <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>createReducer</span> APIs use Immer inside to allow us to write "mutating" <Link to={'/tutorial'} className='text-[#764abc] hover:underline'>update logic that becomes correct immutable updates.</Link>
                    </p>
                    ...
                    <h3 className='text-3xl font-bold mb-5'>Add Slice Reducers to the Store</h3>
                    <p className='mb-5'>
                        Next, we need to import the <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>reducer</span> function from the counter slice and add it to our store. By defining a field inside the reducer parameter, we tell the store to use this slice reducer function to handle all updates to that state.
                    </p>
                    ...
                    <p className='mb-5'>
                        Now we can use the React-Redux hooks to let React components interact with the Redux store. We can read data from the store with <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>useSelector</span>, and dispatch actions using <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>useDispatch</span>. Create a <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>src/features/counter/Counter.js</span> file with a <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>&#60;Counter&#62;</span> component inside, then import that component into <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>App.js</span> and render it inside of  <span className='bg-gray-300 px-2 pb-[3px] border border-gray-500 rounded'>&#60;App&#62;</span>.
                            ...
                            <h3 className='text-3xl font-bold mb-5'>What You've Learned</h3>
                            <p className='mb-5'>
                            ...
                            <h3 className='text-3xl font-bold mb-5'>Full Counter App Example</h3>
                            <p className='mb-5'>
                            ...
                            <h3 className='text-3xl font-bold mb-5'>What's Next?</h3>
                            <p className='mb-5'>
