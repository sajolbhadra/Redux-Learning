        ...
        <div className="p-4 flex flex-wrap gap-4">
          ...
          <div class="card shadow-md lg:w-[30%] mx-auto relative bg-base-100 ">
            ...
            <div class="card-body">
              ...
              <p className="text-center font-bold   text-black">Team Leader</p>
          ...
          <div class="card shadow-md lg:w-[30%] mx-auto relative bg-base-100 ">
            ...
            <div class="card-body">
              ...
              <p className="text-center font-bold  text-black">Team Member</p>
              <div className="w-8 h-1 bg-[#4D4C7D] mx-auto"></div>
              <p className="text-center text-slate-500">
          ...
          <div class="card shadow-md lg:w-[30%] mx-auto relative bg-base-100 ">
            ...
            <div class="card-body">
              ...
              <div class="card-actions justify-center">
                <a className="text-[#4D4C7D] text-2xl" href="https://niloydey.netlify.app/">
                  <MdDeveloperMode />
                </a>
                <a className="text-[#4D4C7D] text-2xl" href="https://www.linkedin.com/in/niloy-dey-8b5847221/">
                  <FaLinkedinIn />
                </a>
                <a className="text-[#4D4C7D] text-2xl" href="https://github.com/Niloy-Dey">
                  <FaGithub />
                </a>
              </div>
            </div>
