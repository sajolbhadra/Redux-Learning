        ...
        <div className='bg-white'>
            <div className="allAdmin pt-5 pb-10">
                ...
                <div className='grid lg:grid-cols-2 md:grid-cols-2 ' >
                    ...
                    <div><img className="mask mask-circle  lg:w-52 md:w-52  md:h-52 image-full lg:h-52 w-48 h-48  my-4 rounded-full border-8 hover:border-indigo-300  mx-auto" src={zilor} alt="" /><p className='mx-auto w-60 rounded-md py-1 navStyle text-center'>Md. Zillur  <br />MERN Stack Developer</p></div>
                </div>
            </div>
        </div>
    );
