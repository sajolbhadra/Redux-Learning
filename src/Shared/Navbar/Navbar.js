...
const Navbar = ({children}) => {
    ...
    const menuItems = <>
        ...
        {
            admin && <li><Link to="/admin" className='hover:bg-green-100 hover:text-black'>Admin</Link></li>
        }
        {
    ...
    const dropdownData = (
        <>
            ...
            <div className="collapse collapse-arrow">
                <input type="checkbox" />
                <div className="collapse-title  font-medium "><Link to="/tutorial">Tutorials</Link></div>
                <div className="collapse-content pl-10">
            ...
            <div className="collapse-title font-medium">{ !user && <Link to="/login">Login</Link>}</div>
        </>
    );
                ...
                {user && (
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex="0" className="dropdown-content menu p-2 shadow bg-slate-700 rounded-box w-52">
                            <div>
                                <li><p className='text-sm text-center' >{user.email}</p></li>
                                <li className='text-center'><button onClick={handleSignOut}>Logout &#10162;</button></li>
                            </div>
                        </ul>
                    </div>
                )}
