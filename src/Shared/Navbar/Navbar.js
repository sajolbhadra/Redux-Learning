...
const Navbar = ({ themeToggler, setTheme, theme }) => {
  ...
  return (
    <div className="fixed top-0 z-50 navStyle navbar  bg-slate-700 text-white px-4">
      ...
      <div className="navbar-end">
        ...
        <div className='cursor-pointer'  onClick={themeToggler}>  
         {
          theme === 'light' ?  <svg  className="swap-on fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
